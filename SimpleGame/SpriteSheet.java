...
SpriteSheet.java - this is a new animation class that all sprites will have.

It manages the data for the image that a sprite will use (how big the image is, what section
of the image should be shown, when the image should change, etc..)
...
public class SpriteSheet {
	...
	public void setPreset(String preset){
		...
		if(preset.toUpperCase().equals("LPC")){
			...
			this.framesPerState = new ArrayList<Integer>();
			this.initFramesPerState();
	...
	public int getStateIndex(String name){
		...
		while(keepGoing){
			...
			if(this.map.get(i).toUpperCase().equals(name.toUpperCase())){
				keepGoing = false;
			}else{
				i++;
			}
	...
	public void setState(String s){
		this.setState(this.getStateIndex(s));
	}
	...
	public void setSpeed(String state, double s){
		this.speed.set(this.getStateIndex(state), s);
	}
	...
	public void setFramesPerState(String state, int frames){
		this.framesPerState.set(this.getStateIndex(state), frames);
	}
